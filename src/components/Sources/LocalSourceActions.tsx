...
interface LocalSourceActionsProps {
  sourceIndex: number;
  onEdit: () => void;
  onDelete: () => void;
}

// Utility functions for export/import (moved from SourceConfig)
...
const LocalSourceActions: React.FC<LocalSourceActionsProps> = ({
  sourceIndex,
  onEdit,
  onDelete,
}) => {
...
export default LocalSourceActions;
